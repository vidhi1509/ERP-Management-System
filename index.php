                    ...
                    <div class="col-md-4 p-0">
                        <div class="auth-form-light text-left p-5">
                            <div class="brand-logo" align="center">
                                <img class="img-avatar mb-3" src="assets/img/companyimages/niet.jpg" alt=""><br>
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                          <div class="carousel-inner">
                            <div class="carousel-item active">
                              <img class="d-block w-100" src="https://www.niet.co.in/images/admissonupseebanner.jpg" alt="First slide" >
                            </div>
                            <div class="carousel-item">
                              <img class="d-block w-100" src="https://img.jagranjosh.com/images/2023/January/512023/Noida-Institute-of-Engineering-and-Technology-NIET-Greater-Noida-Campus-View-1.jpg" alt="Second slide">
                            </div>
                          </div>
